...
public class AuthorService {
    ...
    public Map<String, List<Author>> getGroupAuthorsData(){
        ...
        for (Author author : allAuthor){
            firstLetter = author.getNameAuthor().substring(0,1);
            if(result.containsKey(firstLetter)){
                ...
                result.put(author.getNameAuthor().substring(0,1), tempAuthorList);
            }
